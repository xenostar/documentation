...
<Image alt="Dev environment in browser" path="terminus-cli-open-http.png" />
...
<Image alt="Dashboard in browser" path="dashboard/terminus-cli-open-dash.png" />
...
<Image alt="The dashboard's showing the code was deployed to the Dev environment" path="dashboard/terminus-cli-code-committed-dashboard.png" />
...
<Image alt="The dashboard's showing the code was deployed to the Dev environment" path="dashboard/terminus-commit-with-message.png" />
