...
<Image alt="The dashboard's showing the code was deployed to the Dev environment" path="dashboard/verify-reroute-email-dashboard-commits1.png" />
...
<Image alt="The Reroute Email Configuration menu shows the email settings" path="reroute-email-config-settings.png" />

If you don’t see what you’re expecting, review your settings.php and ensure the commit is showing on your Dashboard:

<Image alt="The dashboard showing the code was deployed to the Dev environment" path="dashboard/verify-reroute-email-dashboard-commits2.png" />
...
<Image alt="Drupal site showing account requested and emails sent" path="reroute-email-account-requested.png" />
...
<Image alt="Email showing the reroute was successful" path="reroute-email-confirmation.png" />
