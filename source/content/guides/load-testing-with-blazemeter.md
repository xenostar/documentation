...
<Image alt="The BlazeMeter settings window" path="blazemeter-settings-example.png" />
...
<Image alt="The BlazeMeter settings window" path="blazemeter-review-results.png" />
...
<Image alt="The BlazeMeter load report" path="blazemeter-load-report.png" />
