...
6. Select **Synthetics** and **Monitor failure** then click **Next, select entities**:
  ...
  <Image alt="New Relic Alert Policy Ping Condition" path="pagerduty/new-relic-policy-ping.png" />

7. Select your new monitor, then **Next, define thresholds**:

  <Image alt="New Relic select entity" path="pagerduty/new-relic-entity.png" />
